...
def chat_rh(question, api_key, dataframe):
    ...
    agent = create_pandas_dataframe_agent(ChatOpenAI(api_key=api_key, temperature=0, model="gpt-3.5-turbo-0613"), dataframe, verbose=True, agent_type=AgentType.OPENAI_FUNCTIONS,)
